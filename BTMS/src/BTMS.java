...
public class BTMS
{
  ...
  public DriverSchedule addSchedule(String aAssignment, Driver aDriver, RouteAssignment aRouteAssignment)
  {
    return new DriverSchedule(aAssignment, aDriver, aRouteAssignment, this);
  }
